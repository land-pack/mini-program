...
Page({
  ...
  onReady: function () {
    ...
    this.drawTarget('filter', '22', '100');
    this.drawTarget('fishFood', '18', '100');
    this.drawTarget('PH', '99', '100');
  },
  ...
  drawMeter: function (name, value, maxvalue) {
    ...
    ctx.arc(width / 2, height / 2, R, 1 * Math.PI, 1 * Math.PI, false); //绘制圆形，坐标250,250 半径200，整圆（0-360度），false表示顺时针     
    ctx.stroke(); //绘图
    ctx.closePath(); //结束画布 
